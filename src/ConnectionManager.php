...
class ConnectionManager
{
	 ...
	 */
	public function connection(string $name = null, $host, $port, $username = null, $password = null): MqttClientContract
	{
		if ($name === null) {
		...
		if (!array_key_exists($name, $this->connections)) {
			$this->connections[$name] = $this->createConnection($name, $host, $port, $username, $password);
		}
	 ...
	 * @throws ProtocolNotSupportedException
	 */
	protected function createConnection(string $name, $host, $port, $username, $password): MqttClientContract
	{
